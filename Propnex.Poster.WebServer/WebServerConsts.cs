namespace Propnex.Poster.WebServer
{
    public class WebServerConsts
    {
        public static string DbTablePrefix = "PropnexPoster";
        ...
        public static string PnfetchMyIpTasks = "";

        public static string PnreadMyIpTask = "";
    }
}
